...
async function checkManufacturingSystem() {
  let connection;
  try {
    connection = await mysql.createConnection({
      ...
      database: 'manufacturing_system'  // ใช้ manufacturing_system แทน manufacturing_system_dev
    });

    const date = '2026-01-23';
    
    console.log('\n📊 ตรวจสอบข้อมูลจากตาราง work_plans (database: manufacturing_system)\n');
    console.log(`Database: manufacturing_system`);
    ...
    // 4. งานที่มี workflow_status = 'draft' แต่ไม่ใช่ A, B, C, D
